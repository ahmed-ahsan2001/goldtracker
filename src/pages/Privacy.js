          ...
          <section className="privacy-section">
            ...
            <div className="adsense-policy">
              <p>
                ...
                how users use the site. Google AdSense also uses web beacons (invisible images). These web 
                beacons allow information such as visitor traffic on these pages to be evaluated.
              </p>
              <p>
                The information generated by cookies and web beacons about your use of this website 
                (including your IP address) and delivery of advertising formats is transmitted to a Google 
                server in the United States and stored there. This information may be passed on by Google 
                to Google’s contractual partners. However, Google will not merge your IP address with 
                other data stored about you.
              </p>
              <p>
